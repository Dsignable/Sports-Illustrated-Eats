...
function si_scripts() {
    ...
    wp_enqueue_style(
        'sports-illustrated-header-fixes',
        get_theme_file_uri('/assets/css/header-fixes.css'),
        array(),
        SI_VERSION . '.' . time() // Force cache bust
    );

    wp_enqueue_style('sports-illustrated-style', get_stylesheet_uri(), array(), SI_VERSION);
    wp_enqueue_style('sports-illustrated-main', get_theme_file_uri('/assets/css/main.css'), array(), SI_VERSION);
}
