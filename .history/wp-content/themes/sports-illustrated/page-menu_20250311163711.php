    ...
    <nav class="menu-container">
        ...
        <section class="image-section">
            <div class="image-wrapper">
                ...
                $burger_menu_pdf = wp_get_attachment_url(get_theme_mod('si_restaurant_menu_burger_pdf'));
                ?>
                <div class="menu-image-container <?php echo $active_menu === 'burger' ? 'active' : ''; ?>" data-menu="burger" <?php echo $active_menu !== 'burger' ? 'style="display: none;"' : ''; ?>>
                    <img src="<?php echo esc_url($burger_menu_image); ?>" 
                         class="menu-image" 
                         alt="Burger Menu">
                    <?php if ($burger_menu_pdf) : ?>
                    <div class="menu-pdf-download">
                        <a href="<?php echo esc_url($burger_menu_pdf); ?>" target="_blank" class="download-btn">
                            <span class="dashicons dashicons-pdf"></span> Download PDF
                        </a>
                    </div>
                    <?php endif; ?>
