                        ...
                        <div class="top-section">
                            ...
                            <div class="text-content">
                                <h1 class="main-heading">
                                    <?php echo esc_html(get_theme_mod('si_featured_top_title', 'WHERE EVERY FAN\'S A VIP')); ?>
                                </h1>
                                <p class="description">
                                    <?php echo esc_html(get_theme_mod('si_vip_text', 'We are dedicated to transforming ordinary fans into VIPs with stadium-level excitement and exceptional hospitality. From the moment you step through our doors until your final high-five goodbye, our team delivers championship-worthy service.')); ?>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="bottom-section">
                            <div class="text-content">
                                <h2 class="main-heading">
                                    <?php echo esc_html(get_theme_mod('si_featured_bottom_title', 'GAME-CHANGING SPECIALS, EVERY DAY OF THE WEEK')); ?>
                                </h2>
                                <p class="description">
                                    <?php echo esc_html(get_theme_mod('si_daily_specials_text', 'MON - $7-12 Burger Mania | TUE - $15 Bottomless Pasta | WED - $10 Wings | THU - $2.5 TACOS | FRI - $3 HAPPY DAD | WEEKENDS $10 Brunch Happy Hour')); ?>
                                </p>
                            </div>
                            <?php
