...
function sports_illustrated_enqueue_assets() {
    ...
    // Enqueue header responsive styles (to fix header display on smaller laptops)
    wp_enqueue_style(
        'sports-illustrated-header-responsive',
        get_theme_file_uri('assets/css/header-responsive.css'),
