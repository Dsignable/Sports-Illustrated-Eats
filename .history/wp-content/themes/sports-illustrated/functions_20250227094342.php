...
function sports_illustrated_enqueue_assets() {
    ...
    wp_enqueue_script(
        ...
        array('jquery'),
        SI_VERSION . '.' . time(), // Force cache bust for debugging
        true
    );

    // Add inline script to check if navigation.js is loaded
    wp_add_inline_script('sports-illustrated-navigation', 'console.log("Navigation script loaded");', 'before');
