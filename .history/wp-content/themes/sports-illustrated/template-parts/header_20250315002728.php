    ...
    <div class="navigation-bar">
        ...
        <nav class="desktop-menu left-menu">
            ...
            for ($i = 1; $i <= 3; $i++) {
                if (get_theme_mod('si_left_menu_visible_' . $i, true)) {
                    ...
                    if ($i === 1 && get_theme_mod('si_enable_menu_dropdown', true)) {
        ...
        <nav class="desktop-menu right-menu">
            ...
            for ($i = 1; $i <= 3; $i++) {
                ...
                if ($i == 2) { // News button
                    // First try to get the posts page ID
                    ...
                    if ($posts_page_id && get_post($posts_page_id)) {
                        ...
                        if ($news_page && 'publish' === get_post_status($news_page)) {
                            ...
                            // Final fallback - use the news archive
                            $menu_url = get_post_type_archive_link('post');
                            if (!$menu_url) {
