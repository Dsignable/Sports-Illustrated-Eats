        ...
        <nav class="primary-nav">
            ...
            <div class="social-links">
                ...
                foreach ($social_platforms as $platform => $details) {
                    $url = get_theme_mod('si_social_' . $platform . '_url', '');
                    $visible = get_theme_mod('si_social_' . $platform . '_visible', $platform === 'instagram');

                    if ($visible && !empty($url)) :
                ?>
                    <a href="<?php echo esc_url($url); ?>" target="_blank" rel="noopener noreferrer" class="nav-button social-icon">
                        <i class="<?php echo esc_attr($details['icon']); ?>"></i>
                        <span class="sr-only">Follow us on <?php echo esc_html($details['label']); ?></span>
                    </a>
                <?php
                    endif;
                }
