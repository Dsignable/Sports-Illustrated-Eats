                    ...
                    if ($i == 1 && $menu_text == 'MENU' && get_theme_mod('si_enable_menu_dropdown', true)) : ?>
                        <div class="menu-dropdown-wrapper">
                            ...
                            <div class="menu-dropdown">
                                <a href="<?php echo esc_url(get_theme_mod('si_menu_dropdown_url_full', home_url('/menu/full/'))); ?>" class="dropdown-item">FULL MENU</a>
                                <a href="<?php echo esc_url(get_theme_mod('si_menu_dropdown_url_drink', home_url('/menu/drink/'))); ?>" class="dropdown-item">DRINK MENU</a>
                                <a href="<?php echo esc_url(get_theme_mod('si_menu_dropdown_url_brunch', home_url('/menu/brunch/'))); ?>" class="dropdown-item">BRUNCH MENU</a>
                                <a href="<?php echo esc_url(get_theme_mod('si_menu_dropdown_url_happy', home_url('/menu/happy/'))); ?>" class="dropdown-item">HAPPY HOUR</a>
                                <a href="<?php echo esc_url(get_theme_mod('si_menu_dropdown_url_today', home_url('/menu/today/'))); ?>" class="dropdown-item">TODAY'S MENU</a>
                            </div>
                        </div>
                    <?php else : ?>
...
<div id="mobile-menu" class="mobile-menu" aria-hidden="true">
    ...
    for ($i = 1; $i <= 3; $i++) {
        ...
        if ($menu_visible && $menu_text) {
            ...
            if ($i == 1 && $menu_text == 'MENU' && get_theme_mod('si_enable_menu_dropdown', true)) {
                echo '<a href="' . esc_url(get_theme_mod('si_menu_dropdown_url_full', home_url('/menu/full/'))) . '" class="mobile-submenu-item">— FULL MENU</a>';
                echo '<a href="' . esc_url(get_theme_mod('si_menu_dropdown_url_drink', home_url('/menu/drink/'))) . '" class="mobile-submenu-item">— DRINK MENU</a>';
                echo '<a href="' . esc_url(get_theme_mod('si_menu_dropdown_url_brunch', home_url('/menu/brunch/'))) . '" class="mobile-submenu-item">— BRUNCH MENU</a>';
                echo '<a href="' . esc_url(get_theme_mod('si_menu_dropdown_url_happy', home_url('/menu/happy/'))) . '" class="mobile-submenu-item">— HAPPY HOUR</a>';
                echo '<a href="' . esc_url(get_theme_mod('si_menu_dropdown_url_today', home_url('/menu/today/'))) . '" class="mobile-submenu-item">— TODAY\'S MENU</a>';
            }
        }
    }
