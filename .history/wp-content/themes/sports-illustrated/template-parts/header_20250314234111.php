                ...
                if (get_theme_mod('si_left_menu_visible_' . $i, true)) {
                    ...
                    if ($i === 1) {
                        ...
                        foreach ($menu_types as $key => $default_label) {
                            if (get_theme_mod('si_menu_dropdown_' . $key . '_visible', true)) {
                                $label = get_theme_mod('si_menu_dropdown_' . $key . '_label', $default_label);
                                $url = get_theme_mod('si_menu_dropdown_' . $key . '_url', home_url('/menu/?menu=' . $key));
                                echo '<a href="' . esc_url($url) . '" class="dropdown-item" data-menu-type="' . esc_attr($key) . '">' . esc_html($label) . '</a>';
                            }
                        }
                        echo '</div></div>';
                    } else {
