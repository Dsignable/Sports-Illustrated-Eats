    ...
    <div class="footer-container">
        <nav class="primary-nav">
            ...
            <div class="social-links">
                ...
                for ($i = 1; $i <= 5; $i++) {
                    $platform = get_theme_mod('si_footer_social_' . $i . '_platform', $i === 1 ? 'instagram' : '');
                    $url = get_theme_mod('si_footer_social_' . $i . '_url', $i === 1 ? 'https://www.instagram.com/si_clubhouse/' : '');
                    $visible = get_theme_mod('si_footer_social_' . $i . '_visible', $i === 1);

                    if ($visible && !empty($platform) && !empty($url)) :
                        $icon_class = si_get_social_icon($platform);
                ...
                ?>
                        <a href="<?php echo esc_url($url); ?>" target="_blank" rel="noopener noreferrer" class="nav-button social-icon">
                            ...
                            <span class="sr-only">Follow us on <?php echo esc_html($platform_name); ?></span>
                        </a>
                <?php
                    endif;
                }
