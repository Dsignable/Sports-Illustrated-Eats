        ...
        <nav class="desktop-menu left-menu">
            ...
            for ($i = 1; $i <= 3; $i++) {
                if (get_theme_mod('si_left_menu_visible_' . $i, true)) {
                    ...
                    $has_dropdown = get_theme_mod('si_left_menu_has_dropdown_' . $i, false);
                    ...
                    if ($has_dropdown) {
                        ...
                        for ($j = 1; $j <= 5; $j++) {
                            if (get_theme_mod('si_left_menu_dropdown_' . $i . '_visible_' . $j, false)) {
                                $dropdown_text = get_theme_mod('si_left_menu_dropdown_' . $i . '_text_' . $j, '');
                                $dropdown_url = get_theme_mod('si_left_menu_dropdown_' . $i . '_url_' . $j, '');
