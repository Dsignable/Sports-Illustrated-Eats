            ...
            <div class="content-wrapper">
                ...
                <div class="highlight-content">
                    <div class="top-section">
                        <img
                            src="<?php echo esc_url(get_theme_file_uri('assets/images/small-plates-left.jpg')); ?>"
                            alt="Small Plates Left"
                            class="left-image"
                        />
                    ...
                    <div class="bottom-section">
                        ...
                        <img
                            src="<?php echo esc_url(get_theme_file_uri('assets/images/modified/plate-right.jpg')); ?>"
                            alt="Plate Right"
                            class="right-image"
                        />
                    </div>
