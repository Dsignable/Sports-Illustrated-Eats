                ...
                <div class="content-wrapper">
                    <div class="highlight-content">
                        <div class="top-section">
                            ...
                            <img
                                src="<?php 
                                    $left_image_id = get_theme_mod('si_featured_left_image');
                                    if ($left_image_id) {
                                        echo esc_url(wp_get_attachment_url($left_image_id));
                                    } else {
                                        echo esc_url(get_theme_file_uri('assets/images/uploaded_defaults/default_left.png'));
                                    }
                                ?>"
                                ...
                                <?php echo $left_style; ?> />
                            <?php
                            // Get position adjustment for top text
                            $top_text_y_pos = get_theme_mod('si_sports_highlights_top_text_y_position', '0');
                            $top_text_style = '';
                            
                            if ($top_text_y_pos != '0') {
                                $top_text_style = 'style="margin-top: ' . esc_attr($top_text_y_pos) . '%;"';
                            }
                            ?>
                            <div class="text-content" <?php echo $top_text_style; ?>>
                        ...
                        <div class="bottom-section">
                            <?php
                            // Get position adjustment for bottom text
                            $bottom_text_y_pos = get_theme_mod('si_sports_highlights_bottom_text_y_position', '0');
                            $bottom_text_style = '';
                            
                            if ($bottom_text_y_pos != '0') {
                                $bottom_text_style = 'style="margin-top: ' . esc_attr($bottom_text_y_pos) . '%;"';
                            }
                            ?>
                            <div class="text-content" <?php echo $bottom_text_style; ?>>
                            ...
                            <img
                                src="<?php 
                                    $right_image_id = get_theme_mod('si_featured_right_image');
                                    if ($right_image_id) {
                                        echo esc_url(wp_get_attachment_url($right_image_id));
                                    } else {
                                        echo esc_url(get_theme_file_uri('assets/images/uploaded_defaults/default_right.png'));
                                    }
                                ?>"
