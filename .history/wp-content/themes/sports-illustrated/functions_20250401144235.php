...
function si_menu_gallery_customizer($wp_customize) {
    ...
    $wp_customize->add_control(new WP_Customize_Media_Control($wp_customize, 'si_menu_gallery_images', array(
        'label'     => __('Gallery Images', 'sports-illustrated'),
        'section'   => 'si_menu_gallery_section',
        'mime_type' => 'image',
        'button_labels' => array(
            'select'       => __('Select Images', 'sports-illustrated'),
            'change'       => __('Change Images', 'sports-illustrated'),
            'remove'       => __('Remove', 'sports-illustrated'),
            'default'      => __('Default', 'sports-illustrated'),
            'placeholder'  => __('No images selected', 'sports-illustrated'),
            'frame_title'  => __('Select Images', 'sports-illustrated'),
            'frame_button' => __('Choose Images', 'sports-illustrated'),
        ),
    )));
