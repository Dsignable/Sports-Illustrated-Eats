...
<main id="primary" class="site-main home-page">
    ...
    <section class="locations-section snap-section">
        <h1 class="locations-title">OUR LOCATIONS</h1>
        <div class="locations-container">
            <article class="location-card">
                <figure class="location-image-wrapper">
                    <img
                        src="<?php echo esc_url(get_theme_file_uri('assets/images/locations/vancouver1.jpg')); ?>"
            ...
            <article class="location-card card-reverse">
                ...
                <figure class="location-image-wrapper">
                    <img
                        src="<?php echo esc_url(get_theme_file_uri('assets/images/locations/vancouver2.jpg')); ?>"
                        alt="<?php esc_attr_e('SI Clubhouse Vancouver Location', 'sports-illustrated'); ?>"
                        class="location-image"
                        loading="lazy"
                    />
