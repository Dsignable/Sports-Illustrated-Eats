...
function si_header_navigation_customizer($wp_customize) {
    ...
    // Add a dedicated section for Menu Dropdown URLs
    $wp_customize->add_section('si_menu_dropdown_urls', array(
        'title'    => __('Menu Dropdown URLs', 'sports-illustrated'),
        'priority' => 31,
        'description' => __('Configure URLs for each menu dropdown item under the MENU button.', 'sports-illustrated'),
    ));
    ...
    foreach ($menu_items as $key => $label) {
        // Menu dropdown item text - keep in header navigation section
        ...
        // Menu dropdown item URL - move to dedicated section
        ...
        $wp_customize->add_control('si_menu_dropdown_url_' . $key, array(
            ...
            'description' => __('Enter the full URL for this menu item', 'sports-illustrated'),
            'section'     => 'si_menu_dropdown_urls',
            'type'        => 'url',
        ));
    }
}
