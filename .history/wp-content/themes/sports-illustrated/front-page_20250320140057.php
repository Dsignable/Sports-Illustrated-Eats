                ...
                <div class="content-wrapper">
                    <div class="highlight-content">
                        <div class="top-section">
                            ...
                            ?>
                            <img
                                src="<?php echo esc_url(get_theme_mod('si_featured_left_image', get_theme_file_uri('assets/images/uploaded_defaults/default_left.png'))); ?>"
                        ...
                        <div class="bottom-section">
                            ...
                            ?>
                            <img
                                src="<?php echo esc_url(get_theme_mod('si_featured_right_image', get_theme_file_uri('assets/images/uploaded_defaults/default_right.png'))); ?>"
