...
/**
 * Add Menu Gallery Settings to Customizer
 */
function si_menu_gallery_customizer($wp_customize) {
    // Add section for menu gallery
    ...
    // Add setting for menu gallery
    $wp_customize->add_setting('si_menu_gallery', array(
        'default'           => '',
        'sanitize_callback' => 'si_sanitize_gallery_images',
    ));

    // Add control for menu gallery
    $wp_customize->add_control(new SI_Gallery_Control($wp_customize, 'si_menu_gallery', array(
        'label'    => __('Menu Gallery Images', 'sports-illustrated'),
        'section'  => 'si_menu_gallery_section',
        'settings' => 'si_menu_gallery',
    )));
}
