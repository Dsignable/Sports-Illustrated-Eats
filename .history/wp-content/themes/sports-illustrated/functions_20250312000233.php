...
function si_contact_page_settings($wp_customize) {
    ...
    $wp_customize->add_control('si_contact_title', array(
        'label'       => __('Page Title', 'sports-illustrated'),
        'description' => __('The main heading displayed on the contact page.', 'sports-illustrated'),
    ...
    $wp_customize->add_control('si_contact_display_type', array(
        ...
        'description' => __('Choose whether to display static contact information or a contact form.', 'sports-illustrated'),
        'section'     => 'si_contact_section',
        'type'        => 'select',
        'choices'     => array(
            'static' => __('Static Contact Information', 'sports-illustrated'),
    ...
    $wp_customize->add_control('si_contact_email', array(
        ...
        'description' => __('Email address displayed on the contact page.', 'sports-illustrated'),
        'section'     => 'si_contact_section',
        'type'        => 'email',
    ));
    ...
    $wp_customize->add_control('si_contact_phone', array(
        ...
        'description' => __('Phone number displayed on the contact page.', 'sports-illustrated'),
        'section'     => 'si_contact_section',
        'type'        => 'text',
    ));
    ...
    $wp_customize->add_control('si_contact_message', array(
        ...
        'description' => __('Message displayed above the contact information.', 'sports-illustrated'),
        'section'     => 'si_contact_section',
        'type'        => 'textarea',
    ));
    ...
    $wp_customize->add_control(new WP_Customize_Media_Control($wp_customize, 'si_contact_image', array(
        ...
        'description' => __('Image displayed on the contact page.', 'sports-illustrated'),
        'section'     => 'si_contact_section',
        'mime_type'   => 'image',
    )));
}
...
function si_home_page_customizer_settings($wp_customize) {
    ...
    $wp_customize->add_section('si_home_page_section', array(
        ...
        'description' => __('Configure the home page sections including hero, experience, featured content, and locations.', 'sports-illustrated'),
        'priority'    => 30,
    ));
