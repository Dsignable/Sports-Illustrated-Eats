...
function si_set_default_menu_values() {
    ...
    $full_defaults = array(
        ...
        'si_written_menu_full_section_6_item_2_name' => '12oz Ribeye',
        'si_written_menu_full_section_6_item_2_description' => '12oz CAB ribeye, truffle butter, roasted rainbow carrots, smashed potatoes',
        'si_written_menu_full_section_6_item_2_price' => '49',
...
function si_direct_reset_menu_defaults_callback() {
    ...
    ?>
    <div class="wrap">
        <h1><?php _e('Reset Menu Defaults', 'sports-illustrated'); ?></h1>
        <div class="notice notice-success">
            <p><?php _e('Menu defaults have been reset successfully!', 'sports-illustrated'); ?></p>
        </div>
        <p><a href="<?php echo admin_url('customize.php?autofocus[section]=si_menu_display_section'); ?>" class="button button-primary"><?php _e('Go to Customizer', 'sports-illustrated'); ?></a></p>
    </div>
    <?php
}

/**
 * Add admin menu item for the Menu Reset Tool
 */
function si_add_menu_reset_tool() {
    add_submenu_page(
        'themes.php',
        __('Menu Reset Tool', 'sports-illustrated'),
        __('Menu Reset Tool', 'sports-illustrated'),
        'manage_options',
        'si-menu-reset-tool',
        'si_menu_reset_tool_redirect'
    );
}
add_action('admin_menu', 'si_add_menu_reset_tool');

/**
 * Redirect to the Menu Reset Tool
 */
function si_menu_reset_tool_redirect() {
    $tool_url = get_template_directory_uri() . '/menu-reset-tool.php';
    ?>
    <script type="text/javascript">
        window.location.href = "<?php echo esc_url($tool_url); ?>";
    </script>
    <p><?php _e('If you are not redirected automatically, please click this link:', 'sports-illustrated'); ?> <a href="<?php echo esc_url($tool_url); ?>"><?php _e('Menu Reset Tool', 'sports-illustrated'); ?></a></p>
    <?php
}