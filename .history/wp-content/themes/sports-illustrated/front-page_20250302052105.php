...
<main id="primary" class="site-main home-page">
    ...
    <div class="snap-section">
        <section class="menu-items">
            ...
            <article class="menu-card brunch">
                <a href="<?php echo esc_url(si_get_menu_card_link('brunch')); ?>" class="menu-card-content">
                    <?php if ($brunch_image = si_get_menu_card_image('brunch')): ?>
                        <img src="<?php echo esc_url($brunch_image); ?>"
                             alt="<?php esc_attr_e('Brunch Menu', 'sports-illustrated'); ?>"
                             class="menu-image"
                             loading="lazy"
                        />
                    <?php endif; ?>
                    <h2 class="menu-title">
                        <?php esc_html_e('BRUNCH', 'sports-illustrated'); ?>
                        <br />
                        <?php esc_html_e('MENU', 'sports-illustrated'); ?>
                    </h2>
                </a>
            </article>

            <article class="menu-card burger">
                <a href="<?php echo esc_url(si_get_menu_card_link('burger')); ?>" class="menu-card-content">
                    <?php if ($burger_image = si_get_menu_card_image('burger')): ?>
                        <img src="<?php echo esc_url($burger_image); ?>"
                             alt="<?php esc_attr_e('Burger Menu', 'sports-illustrated'); ?>"
                             class="menu-image"
                             loading="lazy"
                        />
                    <?php endif; ?>
                    <h2 class="menu-title">
                        <?php esc_html_e('BURGER', 'sports-illustrated'); ?>
                        <br />
                        <?php esc_html_e('MENU', 'sports-illustrated'); ?>
                    </h2>
                </a>
