...
<style>
    ...
    .item-notes {
        ...
        background-color: #444; /* Slightly lighter grey for notes background */
        padding: 2px 6px;
        border-radius: 3px;
        margin-top: 5px;
    }
        ...
        <?php else : ?>
            ...
            <section class="image-section">
                <div class="image-wrapper">
                    <?php
                    // Full Menu
                    $full_menu_image = si_get_image_url('si_menu_full_image', get_theme_file_uri('assets/images/menus/Full_Menu.jpg'));
                    ...
                    <?php
                    // Drink Menu
                    $drink_menu_image = si_get_image_url('si_menu_drink_image', get_theme_file_uri('assets/images/menus/Drink_Menu_On_Tap.jpg'));
                    ...
                    <?php
                    // Brunch Menu
                    $brunch_menu_image = si_get_image_url('si_menu_brunch_image', get_theme_file_uri('assets/images/menus/Brunch_Menu.jpg'));
                    ...
                    <?php
                    // Happy Hour Menu
                    $happy_hour_image = si_get_image_url('si_menu_happy_image', get_theme_file_uri('assets/images/menus/Drink_Menu_Wine.jpg'));
