...
function si_fix_custom_pagination($query) {
    if (!is_admin() && $query->is_main_query()) {
        ...
        if (is_page_template('page-news.php')) {
            ...
            // Important: Set is_page to false and is_home to true for proper pagination
            $query->is_page = false;
            $query->is_home = true;
 ...
 */
function si_fix_pagination_base($link) {
    if (is_page_template('page-news.php')) {
        $link = str_replace('/page/', '/news/page/', $link);
    }
    return $link;
}
add_filter('get_pagenum_link', 'si_fix_pagination_base');