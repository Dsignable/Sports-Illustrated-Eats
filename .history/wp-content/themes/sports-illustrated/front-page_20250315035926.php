            ...
            <div class="hero-section">
                ...
                <div class="hero-content">
                    ...
                    if (count($header_parts) > 1) {
                        ...
                        // Default fallback if customizer setting is not available
                        echo 'SPORTS <span class="brand-highlight">ILLUSTRATED</span><br />CLUBHOUSE';
                    }
                    ?>
                    </h1>
                    
                    <h2 class="content-title"><?php echo esc_html(get_theme_mod('si_experience_subtitle', 'A DINING EXPERIENCE LIKE NO OTHER')); ?></h2>
                    
                    <div class="hero-buttons">
                        <?php 
                        $button1_text = get_theme_mod('si_hero_button1_text', 'MAKE A RESERVATION');
                        $button1_url = get_theme_mod('si_hero_button1_url', home_url('/reservations/'));
                        $button2_text = get_theme_mod('si_hero_button2_text', 'VIEW OUR MENU');
                        $button2_url = get_theme_mod('si_hero_button2_url', home_url('/menu/'));
                        
                        if ($button1_text && $button1_url) : 
                        ?>
                            <a href="<?php echo esc_url($button1_url); ?>" class="hero-button primary-button">
                                <?php echo esc_html($button1_text); ?>
                            </a>
                        <?php endif; 
                        
                        if ($button2_text && $button2_url) : 
                        ?>
                            <a href="<?php echo esc_url($button2_url); ?>" class="hero-button secondary-button">
