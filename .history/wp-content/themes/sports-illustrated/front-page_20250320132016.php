                    ...
                    <div class="highlight-content">
                        ...
                        <div class="bottom-section">
                            <div class="text-content">
                                ...
                                <p class="description">
                                    <?php echo esc_html(get_theme_mod('si_sports_highlights_bottom_description', 'MON - $7-12 Burger Mania<br />TUE - $15 Bottomless Pasta<br />WED - $10 Wings<br />THU - $2.5 TACOS<br />FRI - $3 HAPPY DAD<br />WEEKENDS $10 Brunch Happy Hour')); ?>
                                </p>
                            </div>
                            <?php
