...
/**
 * AJAX handler for menu reset - DEPRECATED
 * This function has been moved to inc/menu-reset-functions.php
 * and is now handled by si_ajax_reset_menu()
 */
/*
...
*/
// Removed duplicate action hook - now using the one in menu-reset-functions.php
