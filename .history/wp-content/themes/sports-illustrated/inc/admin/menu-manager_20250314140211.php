    ...
    <div class="wrap">
        ...
        <div class="menu-manager-container">
            <div class="menu-manager-section">
                ...
                <p><?php echo esc_html__('Manage your restaurant menus directly or through the WordPress Customizer.', 'sports-illustrated'); ?></p>
                ...
                <div class="menu-manager-cards">
                    <div class="menu-manager-card">
                        ...
                        <div class="menu-manager-card-footer">
                            ...
                            <a href="<?php echo esc_url(admin_url('customize.php?autofocus[section]=si_written_menu_drinks_section')); ?>" class="button">
                                <?php echo esc_html__('Edit in Customizer', 'sports-illustrated'); ?>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="menu-manager-card">
                        ...
                        <div class="menu-manager-card-footer">
                            ...
                            <a href="<?php echo esc_url(admin_url('customize.php?autofocus[section]=si_written_menu_brunch_section')); ?>" class="button">
                                <?php echo esc_html__('Edit in Customizer', 'sports-illustrated'); ?>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="menu-manager-card">
                        ...
                        <div class="menu-manager-card-footer">
                            ...
                            <a href="<?php echo esc_url(admin_url('customize.php?autofocus[section]=si_written_menu_full_section')); ?>" class="button">
                                <?php echo esc_html__('Edit in Customizer', 'sports-illustrated'); ?>
                            </a>
                        </div>
                    </div>
                    
                    <div class="menu-manager-card menu-manager-card-all">
                        <div class="menu-manager-card-header">
                            <h3><?php echo esc_html__('All Menus', 'sports-illustrated'); ?></h3>
                        </div>
                        <div class="menu-manager-card-body">
                            <p><?php echo esc_html__('Access all restaurant menus in the WordPress Customizer.', 'sports-illustrated'); ?></p>
                        </div>
                        <div class="menu-manager-card-footer">
                            <a href="<?php echo esc_url(admin_url('customize.php?autofocus[panel]=si_menus_panel')); ?>" class="button button-primary">
                                <?php echo esc_html__('Edit All Menus in Customizer', 'sports-illustrated'); ?>
                            </a>
                        </div>
                    </div>
                </div>
