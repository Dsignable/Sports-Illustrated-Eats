...
function si_home_page_customizer_settings($wp_customize) {
    ...
    $wp_customize->add_setting('si_featured_left_image', array(
        'default'           => get_theme_file_uri('assets/images/uploaded_defaults/default_left.png'),
        'sanitize_callback' => 'esc_url_raw',
    ));

    $wp_customize->add_control(new WP_Customize_Image_Control($wp_customize, 'si_featured_left_image', array(
    ...
    $wp_customize->add_setting('si_featured_right_image', array(
        'default'           => get_theme_file_uri('assets/images/uploaded_defaults/default_right.png'),
        'sanitize_callback' => 'esc_url_raw',
    ));

    $wp_customize->add_control(new WP_Customize_Image_Control($wp_customize, 'si_featured_right_image', array(
