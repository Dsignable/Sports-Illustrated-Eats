...
function si_home_page_customizer_settings($wp_customize) {
    ...
    // Location 1 Reservation Link
    $wp_customize->add_setting('si_location_1_reservation_link', array(
        'default'           => '',
        'sanitize_callback' => 'esc_url_raw',
    ));

    $wp_customize->add_control('si_location_1_reservation_link', array(
        'label'    => __('Location 1 Reservation Link', 'sports-illustrated'),
        'description' => __('Enter the reservation URL for the first location.', 'sports-illustrated'),
        'section'  => 'si_home_page_section',
        'type'     => 'url',
    ));

    // Location 1 Reservation Text
    $wp_customize->add_setting('si_location_1_reservation_text', array(
        'default'           => __('RESERVE A TABLE', 'sports-illustrated'),
        'sanitize_callback' => 'sanitize_text_field',
    ));

    $wp_customize->add_control('si_location_1_reservation_text', array(
        'label'    => __('Location 1 Reservation Button Text', 'sports-illustrated'),
        'description' => __('Enter the text to display on the reservation button for the first location.', 'sports-illustrated'),
        'section'  => 'si_home_page_section',
        'type'     => 'text',
    ));
    ...
    // Location 2 Settings (only shown if enabled)
    ...
    $wp_customize->add_control(new WP_Customize_Control($wp_customize, 'si_location_2_heading', array(
        ...
        'active_callback' => function() {
            return get_theme_mod('si_enable_second_location', true);
        },
    )));
    ...
    // Location 2 Reservation Link
    $wp_customize->add_setting('si_location_2_reservation_link', array(
        'default'           => '',
        'sanitize_callback' => 'esc_url_raw',
    ));

    $wp_customize->add_control('si_location_2_reservation_link', array(
        'label'    => __('Location 2 Reservation Link', 'sports-illustrated'),
    ...
    // Location 2 Reservation Text
    $wp_customize->add_setting('si_location_2_reservation_text', array(
        'default'           => __('RESERVE A TABLE', 'sports-illustrated'),
        'sanitize_callback' => 'sanitize_text_field',
    ));

    $wp_customize->add_control('si_location_2_reservation_text', array(
        'label'    => __('Location 2 Reservation Button Text', 'sports-illustrated'),
        'description' => __('Enter the text to display on the reservation button for the second location.', 'sports-illustrated'),
        'section'  => 'si_home_page_section',
        'type'     => 'text',
        'active_callback' => function() {
            return get_theme_mod('si_enable_second_location', true);
    ...
    // Sports Highlights Top Right Title
    $wp_customize->add_setting('si_sports_highlights_top_title', array(
        'default'           => __('WHERE EVERY FAN\'S A VIP', 'sports-illustrated'),
        'sanitize_callback' => 'sanitize_text_field',
    ));

    $wp_customize->add_control('si_sports_highlights_top_title', array(
        'label'       => __('Sports Highlights Top Title', 'sports-illustrated'),
        'description' => __('Enter the title for the top right sports highlights section.', 'sports-illustrated'),
        'section'     => 'si_home_page_section',
        'type'        => 'text',
    ));

    // Sports Highlights Top Text Y Position
    $wp_customize->add_setting('si_sports_highlights_top_text_y_position', array(
        'default'           => '0',
        'sanitize_callback' => 'sanitize_text_field',
    ));

    $wp_customize->add_control('si_sports_highlights_top_text_y_position', array(
        'label'       => __('Top Text Y Position (%)', 'sports-illustrated'),
        'description' => __('Adjust the vertical position of the top text section (positive values move down, negative values move up).', 'sports-illustrated'),
        'section'     => 'si_home_page_section',
        'type'        => 'number',
        'input_attrs' => array(
            'min'  => -100,
    ...
    // Sports Highlights Top Right Description
    $wp_customize->add_setting('si_sports_highlights_top_description', array(
        'default'           => __('We are dedicated to transforming ordinary fans into VIPs with stadium-level excitement and exceptional hospitality. From the moment you step through our doors until your final high-five goodbye, our team delivers championship-worthy service.', 'sports-illustrated'),
        'sanitize_callback' => 'wp_kses_post',
    ));

    $wp_customize->add_control('si_sports_highlights_top_description', array(
        'label'       => __('Sports Highlights Top Description', 'sports-illustrated'),
        'description' => __('Enter the description for the top right sports highlights section.', 'sports-illustrated'),
        'section'     => 'si_home_page_section',
        'type'        => 'textarea',
    ));

    // Sports Highlights Bottom Left Title
    $wp_customize->add_setting('si_sports_highlights_bottom_title', array(
        'default'           => __('GAME-CHANGING SPECIALS, EVERY DAY OF THE WEEK', 'sports-illustrated'),
        'sanitize_callback' => 'sanitize_text_field',
    ));

    $wp_customize->add_control('si_sports_highlights_bottom_title', array(
        'label'       => __('Sports Highlights Bottom Title', 'sports-illustrated'),
        'description' => __('Enter the title for the bottom left sports highlights section.', 'sports-illustrated'),
        'section'     => 'si_home_page_section',
        'type'        => 'text',
    ));

    // Sports Highlights Bottom Text Y Position
    $wp_customize->add_setting('si_sports_highlights_bottom_text_y_position', array(
        'default'           => '0',
        'sanitize_callback' => 'sanitize_text_field',
    ));

    $wp_customize->add_control('si_sports_highlights_bottom_text_y_position', array(
        'label'       => __('Bottom Text Y Position (%)', 'sports-illustrated'),
        'description' => __('Adjust the vertical position of the bottom text section (positive values move down, negative values move up).', 'sports-illustrated'),
        'section'     => 'si_home_page_section',
        'type'        => 'number',
        'input_attrs' => array(
            'min'  => -100,
    ...
    // Sports Highlights Bottom Left Description
    $wp_customize->add_setting('si_sports_highlights_bottom_description', array(
        'default'           => __('MON - $7-12 BURGER MANIA | TUE - $15 BOTTOMLESS PASTA | WED - $10 WINGS | THU - $2.5 TACOS | FRI - $3 HAPPY DAD | WEEKENDS $10 BRUNCH HAPPY HOUR', 'sports-illustrated'),
        'sanitize_callback' => 'wp_kses_post',
    ));

    $wp_customize->add_control('si_sports_highlights_bottom_description', array(
        'label'       => __('Sports Highlights Bottom Description', 'sports-illustrated'),
        'description' => __('Enter the description for the bottom left sports highlights section.', 'sports-illustrated'),
        'section'     => 'si_home_page_section',
        'type'        => 'textarea',
    ));
