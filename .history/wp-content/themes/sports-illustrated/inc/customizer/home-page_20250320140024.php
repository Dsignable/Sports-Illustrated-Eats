...
function si_home_page_customizer_settings($wp_customize) {
    // Home Page Settings
    $wp_customize->add_section('si_home_page_settings', array(
        'title'    => __('Home Page Settings', 'sports-illustrated'),
        'priority' => 30,
    ));

    // Sports Highlights Section - Top Title
    $wp_customize->add_setting('si_sports_highlights_top_title', array(
        'default'           => 'WHERE EVERY FAN\'S A VIP',
    ...
    $wp_customize->add_control('si_sports_highlights_top_title', array(
        ...
        'section'  => 'si_home_page_settings',
        'type'     => 'text',
    ));

    // Sports Highlights Section - Top Description
    ...
    // Sports Highlights Section - Bottom Title
    $wp_customize->add_setting('si_sports_highlights_bottom_title', array(
        'default'           => 'GAME-CHANGING SPECIALS, EVERY DAY OF THE WEEK',
        'sanitize_callback' => 'sanitize_text_field',
    ));
    ...
    // Sports Highlights Section - Bottom Description
