...
function si_home_page_customizer_settings($wp_customize) {
    ...
    $wp_customize->add_setting('si_about_us_text', array(
        'default'           => si_get_default_content('about_us'),
        'sanitize_callback' => 'wp_kses_post',
    ));
    ...
    $wp_customize->add_control('si_about_us_text', array(
        ...
        'section'     => 'si_home_page_section',
        'type'        => 'textarea',
        'description' => __('Enter the text for the About Us section.', 'sports-illustrated'),
    ));

    // Sports Highlights - VIP Section
    $wp_customize->add_setting('si_vip_text', array(
        'default'           => si_get_default_content('vip_text'),
        'sanitize_callback' => 'wp_kses_post',
    ));
    ...
    $wp_customize->add_control('si_vip_text', array(
        ...
        'section'     => 'si_home_page_section',
        'type'        => 'textarea',
        'description' => __('Enter the text for the VIP section.', 'sports-illustrated'),
    ));

    // Daily Specials Section
    $wp_customize->add_setting('si_specials_text', array(
        'default'           => si_get_default_content('specials'),
        'sanitize_callback' => 'wp_kses_post',
    ));

    $wp_customize->add_control('si_specials_text', array(
        'label'       => __('Daily Specials Text', 'sports-illustrated'),
        'section'     => 'si_home_page_section',
        'type'        => 'textarea',
        'description' => __('Enter the text for the daily specials section.', 'sports-illustrated'),
    ));

    // Section Visibility Settings
    $wp_customize->add_setting('si_show_about_section', array(
        'default'           => true,
        'sanitize_callback' => 'rest_sanitize_boolean',
    ));

    $wp_customize->add_control('si_show_about_section', array(
        'label'    => __('Show About Us Section', 'sports-illustrated'),
        'section'  => 'si_home_page_section',
        'type'     => 'checkbox',
    ));

    $wp_customize->add_setting('si_show_vip_section', array(
        'default'           => true,
        'sanitize_callback' => 'rest_sanitize_boolean',
    ));

    $wp_customize->add_control('si_show_vip_section', array(
        'label'    => __('Show VIP Section', 'sports-illustrated'),
        'section'  => 'si_home_page_section',
        'type'     => 'checkbox',
    ));

    $wp_customize->add_setting('si_show_specials_section', array(
        'default'           => true,
        'sanitize_callback' => 'rest_sanitize_boolean',
    ));

    $wp_customize->add_control('si_show_specials_section', array(
        'label'    => __('Show Daily Specials Section', 'sports-illustrated'),
        'section'  => 'si_home_page_section',
        'type'     => 'checkbox',
    ));

    // Section Titles
    $wp_customize->add_setting('si_about_section_title', array(
        'default'           => __('About Us', 'sports-illustrated'),
        'sanitize_callback' => 'sanitize_text_field',
    ));

    $wp_customize->add_control('si_about_section_title', array(
        'label'    => __('About Section Title', 'sports-illustrated'),
        'section'  => 'si_home_page_section',
        'type'     => 'text',
    ));

    $wp_customize->add_setting('si_vip_section_title', array(
        'default'           => __('Where Every Fan\'s a VIP', 'sports-illustrated'),
        'sanitize_callback' => 'sanitize_text_field',
    ));

    $wp_customize->add_control('si_vip_section_title', array(
        'label'    => __('VIP Section Title', 'sports-illustrated'),
        'section'  => 'si_home_page_section',
        'type'     => 'text',
    ));

    $wp_customize->add_setting('si_specials_section_title', array(
        'default'           => __('Game-Changing Specials, Every Day of the Week', 'sports-illustrated'),
        'sanitize_callback' => 'sanitize_text_field',
    ));

    $wp_customize->add_control('si_specials_section_title', array(
        'label'    => __('Specials Section Title', 'sports-illustrated'),
        'section'  => 'si_home_page_section',
        'type'     => 'text',
    ));
} 