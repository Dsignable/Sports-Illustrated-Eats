...
( function( $ ) {
    ...
    // Fix for URL fields not showing up in the customizer
    $(window).on('load', function() {
        // Make sure URL fields are visible
        setTimeout(function() {
            $('.customize-control-url').each(function() {
                $(this).css('display', 'block');
            });
            
            // Ensure dropdown URL fields are properly shown when dropdown is enabled
            if ($('#customize-control-si_left_menu_has_dropdown_1 input').is(':checked')) {
                $('#customize-control-si_menu_dropdown_url_full, #customize-control-si_menu_dropdown_url_drink, #customize-control-si_menu_dropdown_url_brunch, #customize-control-si_menu_dropdown_url_happy, #customize-control-si_menu_dropdown_url_today').show();
            }
        }, 500);
        
        // Toggle dropdown URL fields when dropdown is toggled
        $('#customize-control-si_left_menu_has_dropdown_1 input').on('change', function() {
            if ($(this).is(':checked')) {
                $('#customize-control-si_menu_dropdown_url_full, #customize-control-si_menu_dropdown_url_drink, #customize-control-si_menu_dropdown_url_brunch, #customize-control-si_menu_dropdown_url_happy, #customize-control-si_menu_dropdown_url_today').show();
            } else {
                $('#customize-control-si_menu_dropdown_url_full, #customize-control-si_menu_dropdown_url_drink, #customize-control-si_menu_dropdown_url_brunch, #customize-control-si_menu_dropdown_url_happy, #customize-control-si_menu_dropdown_url_today').hide();
            }
        });
    });
