        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    // Add customize link
                    $responseContainer.append('<p><a href="' + ajaxurl.replace('admin-ajax.php', '') + 'customize.php?autofocus[section]=si_menu_display_section" class="button button-primary">Customize Menu</a></p>');
                } else {
                    // Show error message
