document.addEventListener('DOMContentLoaded', function() {
    console.log('Navigation script loaded with debug:', window.siDebug);
    ...
    try {
        ...
        if (!hamburger || !mobileMenu) {
            ...
            console.log('Looking for elements with similar classes...');
            document.querySelectorAll('[class*="hamburger"],[class*="menu"],[class*="nav"]').forEach(el => {
                console.log('Found potential menu element:', el.className, el.outerHTML);
            });
            return;
        }
