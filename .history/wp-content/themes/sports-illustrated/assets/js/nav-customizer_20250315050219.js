/**
 * File nav-customizer.js.
 *
 * Navigation Bar Settings Customizer enhancements for a better user experience.
 *
...
( function( $ ) {
    ...
    // Update menu dropdown text and URLs
    menuItems.forEach(function(key) {
        // Update menu dropdown text
        wp.customize('si_nav_menu_dropdown_text_' + key, function(value) {
        ...
        wp.customize('si_nav_menu_dropdown_url_' + key, function(value) {
            value.bind(function(newval) {
        ...
        wp.customize('si_nav_menu_dropdown_visible_' + key, function(value) {
            value.bind(function(newval) {
                if (newval) {
                    $('.menu-dropdown a[data-menu-type="' + key + '"]').show();
                } else {
                    $('.menu-dropdown a[data-menu-type="' + key + '"]').hide();
                }
            });
        });
    });
    ...
    for (let i = 1; i <= 3; i++) {
        ...
        wp.customize('si_nav_left_menu_text_' + i, function(value) {
            value.bind(function(newval) {
                if (i === 1) {
        ...
        wp.customize('si_nav_left_menu_url_' + i, function(value) {
            value.bind(function(newval) {
                if (i === 1) {
        ...
        wp.customize('si_nav_left_menu_visible_' + i, function(value) {
            value.bind(function(newval) {
                if (i === 1) {
                    if (newval) {
        ...
        wp.customize('si_nav_left_menu_has_dropdown_' + i, function(value) {
            value.bind(function(newval) {
    ...
    for (let i = 1; i <= 3; i++) {
        ...
        wp.customize('si_nav_right_menu_text_' + i, function(value) {
            value.bind(function(newval) {
        ...
        wp.customize('si_nav_right_menu_url_' + i, function(value) {
            value.bind(function(newval) {
                const $item = $('.right-menu > a.nav-button, .right-menu > div > a.nav-button').eq(i-1);
        ...
        wp.customize('si_nav_right_menu_visible_' + i, function(value) {
            value.bind(function(newval) {
        ...
        wp.customize('si_nav_right_menu_has_dropdown_' + i, function(value) {
            value.bind(function(newval) {
                // This requires a page refresh to take effect properly
                // We'll show a message to the user
                const $item = $('.right-menu > a.nav-button, .right-menu > div > a.nav-button').eq(i-1);
        ...
        for (let j = 1; j <= 5; j++) {
            ...
            wp.customize('si_nav_right_menu_dropdown_' + i + '_text_' + j, function(value) {
                value.bind(function(newval) {
            ...
            wp.customize('si_nav_right_menu_dropdown_' + i + '_url_' + j, function(value) {
                value.bind(function(newval) {
                    const $dropdown = $('.right-menu > div').eq(i-1).find('.menu-dropdown');
                    const $item = $dropdown.find('a.dropdown-item').eq(j-1);
                    $item.attr('href', newval);
            ...
            wp.customize('si_nav_right_menu_dropdown_' + i + '_visible_' + j, function(value) {
                value.bind(function(newval) {
                    const $dropdown = $('.right-menu > div').eq(i-1).find('.menu-dropdown');
                    const $item = $dropdown.find('a.dropdown-item').eq(j-1);
                    if (newval) {
