        ...
        <section class="menu-items">
            <article class="menu-card">
                <a href="<?php echo esc_url(si_get_menu_card_link('happy_hour')); ?>" class="menu-card-content">
                    <?php 
                    $happy_hour_image = si_get_menu_card_image('happy_hour', get_theme_file_uri('assets/images/menu-cards/happy-hour.jpg'));
                    ?>
            ...
            <article class="menu-card">
                <a href="<?php echo esc_url(si_get_menu_card_link('fan_favorites')); ?>" class="menu-card-content">
                    <?php 
                    $fan_favorites_image = si_get_menu_card_image('fan_favorites', get_theme_file_uri('assets/images/menu-cards/fan-favorites.jpg'));
                    ?>
            ...
            <article class="menu-card">
                <a href="<?php echo esc_url(si_get_menu_card_link('drinks_cocktails')); ?>" class="menu-card-content">
                    <?php 
                    $drinks_cocktails_image = si_get_menu_card_image('drinks_cocktails', get_theme_file_uri('assets/images/menu-cards/drinks-cocktails.jpg'));
                    ?>
