...
function si_header_navigation_customizer($wp_customize) {
    ...
    foreach ($menu_items as $key => $label) {
        ...
        // Menu dropdown item URL - Using a standard text control instead of URL type
        ...
        $wp_customize->add_control('si_menu_dropdown_url_' . $key, array(
            ...
            'description' => __('Enter the full URL where this menu item should link to (include https://)', 'sports-illustrated'),
            'section'     => 'si_header_navigation',
            'type'        => 'text', // Changed from 'url' to 'text' for better compatibility
            'priority'    => 20,
            'input_attrs' => array(
