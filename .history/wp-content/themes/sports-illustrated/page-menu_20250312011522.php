...
// Get menu size from customizer
$menu_size = get_theme_mod('si_menu_image_size', '1');
$menu_size_style = '';
if ($menu_size != '1') {
    $menu_size_style = 'style="transform: scale(' . esc_attr($menu_size) . '); transform-origin: top center; margin-bottom: ' . (intval($menu_size) * 50) . 'px;"';
}
?>
