...
function sports_illustrated_enqueue_assets() {
    ...
    // Enqueue small laptop specific styles
    wp_enqueue_style(
        'sports-illustrated-small-laptop',
        get_theme_file_uri('assets/css/small-laptop.css'),
        array('sports-illustrated-main', 'sports-illustrated-buttons'),
        SI_VERSION . '.' . time()  // Force cache bust
    );

    // Enqueue extra small screens specific styles
    wp_enqueue_style(
        'sports-illustrated-extra-small-screens',
        get_theme_file_uri('assets/css/extra-small-screens.css'),
        array('sports-illustrated-main', 'sports-illustrated-buttons', 'sports-illustrated-small-laptop'),
        SI_VERSION . '.' . time()  // Force cache bust
    );
