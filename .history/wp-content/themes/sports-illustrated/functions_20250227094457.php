...
function sports_illustrated_enqueue_assets() {
    ...
    // Enqueue navigation script with debug info
    wp_register_script(
    ...
    wp_localize_script('sports-illustrated-navigation', 'siDebug', $debug_data);
    
    // Now enqueue the script
    wp_enqueue_script('sports-illustrated-navigation');

    // Remove other scripts temporarily for debugging
    /*
    wp_enqueue_script(
