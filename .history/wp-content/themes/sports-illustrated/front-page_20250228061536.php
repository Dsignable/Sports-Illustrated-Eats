            ...
            <div class="content-wrapper">
                <div class="row">
                    <div class="image-column">
                        <img
                            src="<?php echo esc_url(si_get_image_url('si_image_sports_highlights_1')); ?>"
                            alt="<?php esc_attr_e('Sports Highlights Image 1', 'sports-illustrated'); ?>"
                            class="feature-image"
                        />
                    </div>
                    <div class="text-column">
                        ...
                        <h2 class="main-heading">
                            <?php esc_html_e('SPORTS ILLUSTRATED', 'sports-illustrated'); ?>
                            <br />
                            <?php esc_html_e('CLUBHOUSE', 'sports-illustrated'); ?>
                        </h2>
                        <p class="description">
                            <?php esc_html_e(
                                'Welcome to Sports Illustrated Clubhouse, where the thrill of the game meets ' .
                                'exceptional dining. Our unique venue combines the electric atmosphere of sports ' .
                                'with elevated cuisine, creating an unforgettable experience for fans and food ' .
                                'lovers alike.',
                                'sports-illustrated'
                            ); ?>
                        </p>
                ...
                <div class="row reverse">
                    <div class="image-column">
                        <img
                            src="<?php echo esc_url(si_get_image_url('si_image_sports_highlights_2')); ?>"
                            alt="<?php esc_attr_e('Sports Highlights Image 2', 'sports-illustrated'); ?>"
                            class="feature-image"
                        />
                    </div>
                    <div class="text-column">
