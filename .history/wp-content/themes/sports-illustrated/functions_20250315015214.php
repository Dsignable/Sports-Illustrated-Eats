...
function si_header_navigation_customizer($wp_customize) {
    ...
    // Add a notice about URL customization
    ...
    foreach ($menu_items as $key => $label) {
        ...
        // Menu dropdown item URL - Make this control more visible
        ...
        $wp_customize->add_control('si_menu_dropdown_url_' . $key, array(
            ...
            'description' => __('Enter the full URL where this menu item should link to. This controls where visitors will go when clicking this menu item.', 'sports-illustrated'),
            'section'     => 'si_header_navigation',
            'type'        => 'url',
            'priority'    => 21, // Set priority one higher than the text field to ensure it appears right after
        ));
    }
}
