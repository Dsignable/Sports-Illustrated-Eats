...
// Ensure we have posts before trying to access them
                    ...
                    <article class="news-card">
                        <a href="<?php the_permalink(); ?>" class="news-card-link">
                            <div class="news-card-image">
                                ...
                                <?php else : 
                                    $default_image = get_theme_file_uri('assets/images/placeholder-news.jpg');
                                    if ($default_image) :
                                        echo '<img src="' . esc_url($default_image) . '" alt="' . esc_attr(get_the_title()) . '" class="news-thumbnail">';
                                    endif;
                                endif; ?>
