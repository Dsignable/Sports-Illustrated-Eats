...
function si_reset_drinks_menu_defaults() {
    ...
    if (function_exists('si_set_drinks_menu_defaults')) {
        error_log('Using existing si_set_drinks_menu_defaults function');
    ...
    // If function doesn't exist, try to include the file
    error_log('si_set_drinks_menu_defaults function not found, attempting to load it');
    ...
    if (file_exists($inc_file)) {
        ...
        if (function_exists('si_set_drinks_menu_defaults')) {
            error_log('Successfully loaded si_set_drinks_menu_defaults function from inc directory');
            si_set_drinks_menu_defaults();
    ...
    if (file_exists($root_file)) {
        ...
        // Check if the global $drinks_defaults array is available
        global $drinks_defaults;
        
        if (isset($drinks_defaults) && is_array($drinks_defaults)) {
            error_log('Using $drinks_defaults array from root directory');
        ...
        } else if (function_exists('si_set_drinks_menu_defaults')) {
            error_log('Successfully loaded si_set_drinks_menu_defaults function from root directory');
            si_set_drinks_menu_defaults();
    ...
    // If we get here, we couldn't find the function or the defaults array
    error_log('Failed to load drinks menu defaults from either location');
    return array(
        'success' => false,
        'message' => __('Failed to load drinks menu defaults. Please contact the theme developer.', 'sports-illustrated')
    );
}
