        ...
        <div class="menu-manager-container">
            <div class="menu-manager-section">
                ...
                <div class="menu-manager-actions menu-manager-reset-actions">
                    ...
                    <a href="<?php echo esc_url(admin_url('themes.php?page=si-menu-manager&reset_drinks=1')); ?>" class="button button-primary">
                        <?php echo esc_html__('Force Reset Drinks Menu', 'sports-illustrated'); ?>
                    </a>
                </div>
...
function si_enqueue_menu_manager_scripts($hook) {
    ...
    wp_localize_script('si-menu-manager-scripts', 'siMenuManager', array(
        ...
        'resetSuccess' => __('Menu has been reset to default values.', 'sports-illustrated'),
        'resetError' => __('An error occurred while resetting the menu.', 'sports-illustrated')
    ));
}
