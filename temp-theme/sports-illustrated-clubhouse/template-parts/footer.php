    ...
    <div class="footer-container">
        <nav class="primary-nav">
            ...
            <div class="social-links">
                <?php
                $instagram_url = get_theme_mod('si_footer_instagram', 'https://www.instagram.com/si_clubhouse/');
                if (!empty($instagram_url)) :
                ?>
                    <a href="<?php echo esc_url($instagram_url); ?>" target="_blank" rel="noopener noreferrer" class="nav-button social-icon">
