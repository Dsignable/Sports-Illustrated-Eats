...
// Include menu reset functions
require_once get_template_directory() . '/inc/menu-reset-functions.php';

// Include admin menu manager
require_once get_template_directory() . '/inc/admin/menu-manager.php';

// Include menu templates
require_once get_template_directory() . '/inc/menu-templates.php';
...
require_once get_template_directory() . '/inc/menu-utilities.php';
