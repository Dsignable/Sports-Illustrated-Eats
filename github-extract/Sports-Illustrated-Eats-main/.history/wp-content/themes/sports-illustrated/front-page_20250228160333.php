    ...
    <div class="snap-section">
        <section class="experience-card">
            ...
            if ($top_photo_id) {
                ...
                ?>
                <div class="experience-photo top-right">
                    <img src="<?php echo esc_url($top_photo_url); ?>" alt="Experience Top" loading="lazy">
                </div>
                <?php
            }
            ...
            if ($bottom_photo_id) {
                ...
                ?>
                <div class="experience-photo bottom-left">
                    <img src="<?php echo esc_url($bottom_photo_url); ?>" alt="Experience Bottom" loading="lazy">
                </div>
                <?php
            }
            ?>
