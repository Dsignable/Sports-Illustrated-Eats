...
function sports_illustrated_scripts() {
    // ... existing enqueues ...
    
    wp_enqueue_script('sports-illustrated-scroll-animations', get_template_directory_uri() . '/assets/js/scroll-animations.js', array('jquery'), _S_VERSION, true);
    
    // Add menu script
    wp_enqueue_script('sports-illustrated-menu', get_template_directory_uri() . '/assets/js/menu.js', array(), _S_VERSION, true);
}

add_action('wp_enqueue_scripts', 'sports_illustrated_scripts'); 