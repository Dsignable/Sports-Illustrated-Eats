...
<main id="primary" class="site-main home-page">
    ...
    <div class="snap-section">
        <section class="menu-items">
            ...
            <!-- Happy Hour Customizer Image -->
            <div class="debug-image">
                <p>Happy Hour Customizer Image:</p>
                <?php 
                $happy_hour_customizer = si_get_menu_card_image('happy_hour');
                if ($happy_hour_customizer) {
                    echo '<img src="' . esc_url($happy_hour_customizer) . '" alt="Happy Hour Customizer" style="max-width: 100%; height: auto;">';
                } else {
                    echo '<p>No customizer image set</p>';
                }
                ?>
            </div>
            ...
            <!-- Fan Favorites Customizer Image -->
            <div class="debug-image">
                <p>Fan Favorites Customizer Image:</p>
                <?php 
                $fan_favorites_customizer = si_get_menu_card_image('fan_favorites');
                if ($fan_favorites_customizer) {
                    echo '<img src="' . esc_url($fan_favorites_customizer) . '" alt="Fan Favorites Customizer" style="max-width: 100%; height: auto;">';
                } else {
                    echo '<p>No customizer image set</p>';
                }
                ?>
            ...
            <!-- Drinks & Cocktails Customizer Image -->
            <div class="debug-image">
                <p>Drinks & Cocktails Customizer Image:</p>
                <?php 
                $drinks_cocktails_customizer = si_get_menu_card_image('drinks_cocktails');
                if ($drinks_cocktails_customizer) {
                    echo '<img src="' . esc_url($drinks_cocktails_customizer) . '" alt="Drinks & Cocktails Customizer" style="max-width: 100%; height: auto;">';
                } else {
                    echo '<p>No customizer image set</p>';
                }
                ?>
