                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response && response.success) {
                            ...
                            const errorMessage = $('<div class="notice notice-error is-dismissible"><p>Error: ' + errorMsg + '</p></div>');
                    ...
                    error: function(xhr, status, error) {
                        ...
                        // Show error message
                        const errorMessage = $('<div class="notice notice-error is-dismissible"><p>An error occurred while resetting the menu. Please try again.</p></div>');
                        $('.menu-manager-section').prepend(errorMessage);
