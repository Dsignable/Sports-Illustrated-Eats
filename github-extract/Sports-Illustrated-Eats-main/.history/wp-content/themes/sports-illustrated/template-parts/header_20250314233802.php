                ...
                if (get_theme_mod('si_left_menu_visible_' . $i, true)) {
                    ...
                    if ($i === 1) {
                        ...
                        $menu_types = array(
                            'full' => array(
                                'label' => 'Full Menu',
                                'url' => get_theme_mod('si_menu_dropdown_url_full', home_url('/menu/?menu=full')),
                                'fallback' => home_url('/menu/?menu=full')
                            ),
                            'drink' => array(
                                'label' => 'Drink Menu',
                                'url' => get_theme_mod('si_menu_dropdown_url_drink', home_url('/menu/?menu=drink')),
                                'fallback' => home_url('/menu/?menu=drink')
                            ),
                            'brunch' => array(
                                'label' => 'Brunch Menu',
                                'url' => get_theme_mod('si_menu_dropdown_url_brunch', home_url('/menu/?menu=brunch')),
                                'fallback' => home_url('/menu/?menu=brunch')
                            ),
                            'happy' => array(
                                'label' => 'Happy Hour',
                                'url' => get_theme_mod('si_menu_dropdown_url_happy', home_url('/menu/?menu=happy')),
                                'fallback' => home_url('/menu/?menu=happy')
                            ),
                            'today' => array(
                                'label' => 'Today\'s Menu',
                                'url' => get_theme_mod('si_menu_dropdown_url_today', home_url('/menu/?menu=today')),
                                'fallback' => home_url('/menu/?menu=today')
                            )
                        );
