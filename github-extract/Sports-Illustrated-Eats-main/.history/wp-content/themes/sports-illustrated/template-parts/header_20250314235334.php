                ...
                if (get_theme_mod('si_left_menu_visible_' . $i, true)) {
                    ...
                    if ($i === 1) {
                        ...
                        $menu_types = array(
                            'full' => array(
                                'label' => 'Full Menu',
                                'url' => home_url('/menu/?type=full'),
                                'fallback' => home_url('/menu/')
                            ),
                            'drink' => array(
                                'label' => 'Drink Menu',
                                'url' => home_url('/menu/?type=drink'),
                                'fallback' => home_url('/menu/?type=drink')
                            ),
                            'brunch' => array(
                                'label' => 'Brunch Menu',
                                'url' => home_url('/menu/?type=brunch'),
                                'fallback' => home_url('/menu/?type=brunch')
                            ),
                            'happy' => array(
                                'label' => 'Happy Hour',
                                'url' => home_url('/menu/?type=happy'),
                                'fallback' => home_url('/menu/?type=happy')
                            ),
                            'today' => array(
                                'label' => 'Today\'s Menu',
                                'url' => home_url('/menu/?type=today'),
