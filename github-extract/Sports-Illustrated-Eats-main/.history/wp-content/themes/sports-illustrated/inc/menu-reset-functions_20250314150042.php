...
function si_reset_drinks_menu_defaults() {
    ...
    if (!function_exists('si_set_drinks_menu_defaults')) {
        error_log('si_set_drinks_menu_defaults function does not exist');
        require_once get_template_directory() . '/inc/drinks_menu_defaults.php';
        ...
        if (!function_exists('si_set_drinks_menu_defaults')) {
            ...
            return array(
                'success' => false,
                'message' => __('Failed to load drinks menu defaults.', 'sports-illustrated')
            );
        }
    }
    ...
    try {
        ...
        return array(
            'success' => false,
            'message' => __('Error resetting drinks menu.', 'sports-illustrated')
        );
    }
