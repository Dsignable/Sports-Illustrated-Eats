...
class SI_Menu_Manager {
    ...
    public function render_menu_page() {
        ?>
        <div class="wrap">
            <h1><?php echo esc_html__('Menu Manager', 'sports-illustrated'); ?></h1>
            
            <div class="menu-manager-container">
                <div class="menu-manager-section">
                    <h2><?php echo esc_html__('Written Menus', 'sports-illustrated'); ?></h2>
                    <p><?php echo esc_html__('Manage your written menus through the WordPress Customizer.', 'sports-illustrated'); ?></p>
                    ...
                    <div class="menu-manager-actions">
                        <a href="<?php echo esc_url(admin_url('customize.php?autofocus[panel]=si_menus_panel')); ?>" class="button button-primary">
                            <?php echo esc_html__('Edit Written Menus', 'sports-illustrated'); ?>
                        </a>
                        
                        <a href="<?php echo esc_url(admin_url('themes.php?page=reset-menu-defaults')); ?>" class="button">
                            <?php echo esc_html__('Reset All Menu Defaults', 'sports-illustrated'); ?>
                        </a>
                        
                        <a href="<?php echo esc_url(admin_url('themes.php?page=reset-drinks-menu')); ?>" class="button">
                            <?php echo esc_html__('Reset Drinks Menu Only', 'sports-illustrated'); ?>
                        </a>
                    </div>
                </div>
