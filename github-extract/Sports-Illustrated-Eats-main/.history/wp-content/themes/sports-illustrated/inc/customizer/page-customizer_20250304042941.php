    ...
    class SI_Gallery_Control extends WP_Customize_Control {
        ...
        public function render_content() {
            ...
            jQuery(document).ready(function($) {
                ...
                var frame;
                var $control = $('#customize-control-<?php echo esc_attr($this->id); ?>');
                var $input = $control.find('.gallery-input');
                var $count = $control.find('.gallery-count');
                ...
                $uploadButton.on('click', function(e) {
                    ...
                    // Pre-select images when opening the frame
