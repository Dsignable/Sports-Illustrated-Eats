    ...
    <div class="snap-scroll" id="snap-container">
        ...
        <div class="snap-section">
            <div class="hero-section">
                ...
                <div class="hero-content">
                    <h1 data-animation="fade-in-up">SPORTS ILLUSTRATED CLUBHOUSE</h1>
                    <p data-animation="fade-in-up" data-delay="200">Experience the Game Like Never Before</p>
                </div>
            </div>
        </div>
        ...
        <div class="snap-section">
            <section class="menu-items">
                ...
                <article class="menu-card happy-hour" data-animation="fade-in-left">
                ...
                <article class="menu-card fan-favorites" data-animation="fade-in-up" data-delay="200">
                ...
                <article class="menu-card drinks-cocktails" data-animation="fade-in-right" data-delay="400">
        ...
        <div class="snap-section">
            <section class="experience-card">
                ...
                if ($top_photo_id) {
                    ...
                    echo '<img src="' . esc_url($top_photo_url) . '" alt="Experience Top" class="experience-photo-top" data-animation="fade-in-left">';
                }
                
                if ($bottom_photo_id) {
                    $bottom_photo_url = wp_get_attachment_image_url($bottom_photo_id, 'large');
                    echo '<img src="' . esc_url($bottom_photo_url) . '" alt="Experience Bottom" class="experience-photo-bottom" data-animation="fade-in-right" data-delay="200">';
                }
                ?>

                <h1 class="brand-header" data-animation="fade-in-up">
                    Sports
                ...
                <div class="content-wrapper">
                    ...
                    <div class="highlight-content">
                        <div class="top-section">
                            ...
                            />
                            <div class="text-content" data-animation="fade-in-right" data-delay="200">
        ...
        <div class="snap-section">
            <section class="locations-section">
                <h1 class="locations-title" data-animation="fade-in-up">OUR LOCATIONS</h1>
                <div class="locations-container">
                    <article class="location-card" data-animation="fade-in-left">
                    ...
                    <article class="location-card card-reverse" data-animation="fade-in-right" data-delay="200">
                    <figure class="location-image-wrapper">
                            <img
