...
function si_menu_customizer_settings($wp_customize) {
    ...
    // Menu settings array for the menu page
    $menu_types = array(
        'full' => 'Full Menu',
    ...
    foreach ($menu_types as $menu_id => $menu_name) {
        // Menu Image Setting
        $wp_customize->add_setting('si_menu_page_' . $menu_id . '_image', array(
            'default' => '',
        ...
        // Menu PDF Setting
        $wp_customize->add_setting('si_menu_page_' . $menu_id . '_pdf', array(
            'default' => '',
            'sanitize_callback' => 'absint'
        ));
...
function si_get_menu_page_image($menu_id) {
    $attachment_id = get_theme_mod('si_menu_page_' . $menu_id . '_image');
    if ($attachment_id) {
...
// Helper function to get menu PDF URL
function si_get_menu_page_pdf($menu_id) {
    $attachment_id = get_theme_mod('si_menu_page_' . $menu_id . '_pdf');
    if ($attachment_id) {
