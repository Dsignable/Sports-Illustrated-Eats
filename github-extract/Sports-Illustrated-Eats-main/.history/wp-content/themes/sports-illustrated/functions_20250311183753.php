...
function si_gift_cards_customizer_settings($wp_customize) {
    ...
    $wp_customize->add_section('si_gift_cards_section', array(
        ...
        'description' => __('Configure the appearance and content of the Gift Cards page, including background image, title, and description.', 'sports-illustrated'),
        'priority' => 30,
    ));
    ...
    $wp_customize->add_control('si_gift_cards_bg_opacity', array(
        ...
        'description' => __('Set the darkness level of the overlay on the background (higher values = darker overlay).', 'sports-illustrated'),
        'section'  => 'si_gift_cards_section',
        'type'     => 'select',
        'choices'  => array(
            '0.3' => '30%',
...
function si_home_page_customizer_settings($wp_customize) {
    ...
    $wp_customize->add_setting('si_featured_top_description', array(
        'default'           => __('The Sports Illustrated Clubhouse interior is a celebration of sports culture, blending sophistication with a vibrant, game-day atmosphere. From the moment you walk in, you're surrounded by iconic memorabilia, larger-than-life murals of legendary athletes, and screens broadcasting the biggest moments in sports history.', 'sports-illustrated'),
        'sanitize_callback' => 'sanitize_textarea_field',
    ));
    ...
    $wp_customize->add_setting('si_featured_bottom_description', array(
        'default'           => __('Our signature dishes are inspired by the energy and spirit of sports, blending bold flavors with fresh, locally sourced ingredients. Whether you're catching the big game with friends or celebrating a special occasion, our menu features a lineup of winning options.', 'sports-illustrated'),
        'sanitize_callback' => 'sanitize_textarea_field',
    ));
