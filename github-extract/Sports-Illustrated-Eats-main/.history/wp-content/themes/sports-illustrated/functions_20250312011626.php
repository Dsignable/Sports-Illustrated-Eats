...
function sports_illustrated_setup() {
     ...
     */
    load_textdomain('sports-illustrated', get_template_directory() . '/languages/sports-illustrated.mo');
    ...
    register_nav_menus(
        array(
            ...
            'footer' => esc_html__('Footer Menu', 'sports-illustrated'),
        )
    );
...
function si_menu_page_customizer($wp_customize) {
    ...
    // Menu Size Control
    $wp_customize->add_setting('si_menu_image_size', array(
        'default'           => '1',
        'sanitize_callback' => 'sanitize_text_field',
    ));

    $wp_customize->add_control('si_menu_image_size', array(
        'label'    => __('Menu Image Size', 'sports-illustrated'),
        'description' => __('Adjust the size of menu images.', 'sports-illustrated'),
        'section'  => 'si_menu_page_section',
        'type'     => 'select',
        'choices'  => array(
            '1' => __('Normal (1x)', 'sports-illustrated'),
            '1.5' => __('Medium (1.5x)', 'sports-illustrated'),
            '2' => __('Large (2x)', 'sports-illustrated'),
            '2.5' => __('Extra Large (2.5x)', 'sports-illustrated'),
            '3' => __('Maximum (3x)', 'sports-illustrated'),
        ),
    ));
