...
// Include reset drinks menu script
require_once get_template_directory() . '/reset-drinks-menu.php';

// Include menu diagnostics script
require_once get_template_directory() . '/menu-diagnostics.php';
